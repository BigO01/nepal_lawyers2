              ...
              <div class="row">
                <div class="col-lg-10">
                  ...
                  <div class="well bs-component">
				  	 {!! Form::open(['route'=>'Adminiscontroller/save.lang', 'method'=>'post', 'id'=>'addlang', 'class'=>'form-horizontal']) !!}
                  {{ csrf_field() }}
                      <fieldset>
					...
					@endif
                        <div class="form-group">
                          ...
                          <div class="col-lg-10">
                            <input id="langname" type="text" name="langname" placeholder="Language Name" class="form-control" value="{{ old('langname')}}" required>
                          </div>
                        </div>
						 <div class="form-group">
