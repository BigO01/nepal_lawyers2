...
<div class="row">
                  ...
                  {{ csrf_field() }}
					...
					@endif
                        ...
                        <div class="form-group">
                          <label for="stname" class="col-lg-2 control-label">Province Name</label>
                          <div class="col-lg-10">
   <!--                          <select name="stname" class="form-control" required>
                            ...
                            <select class="form-control" name="stname" id="region" onchange="sta(this);" required>
                              <option value="">---Select---</option> 
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-10">
                            <select id="state" name="stname" class="form-control" onchange="cities(this);" required>
                              <option value="">---Select---</option>  
