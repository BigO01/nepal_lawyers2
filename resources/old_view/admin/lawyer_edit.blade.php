...
<div class="row">
              ...
              <div class="row">
                <div class="col-lg-10">
                  <div class="well bs-component">
				  	 {!! Form::open(['route'=>'Adminiscontroller/update.lawyer', 'method'=>'post', 'id'=>'editlawyer', 'class'=>'form-horizontal', 'files'=>'true']) !!}
                  {{ csrf_field() }}
                      <fieldset>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-10">
                            <input id="ufname" type="text" name="ufname" placeholder="First Name" class="form-control" value="{{ $tem[0]->first_name }}">
                          </div>
                        </div>
						 <div class="form-group">
                          <label for="ulname" class="col-lg-2 control-label">Last Name</label>
                          <div class="col-lg-10">
                            <input id="ulname" type="text" name="ulname" placeholder="Last Name" class="form-control" value="{{ $tem[0]->last_name }}">
                          </div>
                        </div>
						<div class="form-group">
						...
						<div class="form-group">
                          ...
                          <div class="col-lg-10">
                            <input id="exp" type="number" max="60" min="0" step=".1"  name="exp" placeholder="Experience" class="form-control" value="{{ $tem[0]->experience }}">
                          </div>
                        </div>
						<div class="form-group">
    ...
    <label for="{{$expertise['id']}}">{{$expertise['expertise_name']}}&nbsp;&nbsp;&nbsp;&nbsp;</label>
						...
						<div class="form-group">
                          <label for="rgname" class="col-lg-2 control-label">Region</label>
                          <div class="col-lg-10">
						  	<select id="rgname" name="rgname" class="form-control" >
						...
						<div class="form-group">
                          <label for="stname" class="col-lg-2 control-label">State</label>
                          <div class="col-lg-10">
						  	<select id="stname" name="stname" class="form-control" >
								<option value="">---Select---</option>
						...
						<div class="form-group">
                          ...
                          <div class="col-lg-10">
						  	<select id="ctname" name="ctname" class="form-control" >
								<option value="">---Select---</option>
						...
						<div class="form-group">
                          <label for="uimg" class="col-lg-2 control-label">Lawyer Image</label>
                          <div class="col-lg-10">
