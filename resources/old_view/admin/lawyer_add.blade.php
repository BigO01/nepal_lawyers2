...
<div class="row">
              ...
              <div class="row">
                <div class="col-lg-10">
                  ...
                  <div class="well bs-component">
				  	 {!! Form::open(['route'=>'Adminiscontroller/save.lawyer', 'method'=>'post', 'id'=>'addlawyer', 'class'=>'form-horizontal', 'files'=>'true']) !!}
                  {{ csrf_field() }}
                      <fieldset>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-10">
                            <input id="ufname" type="text" name="ufname" placeholder="First Name" class="form-control" value="" required>
                          </div>
                        </div>
						 <div class="form-group">
                          <label for="ulname" class="col-lg-2 control-label">Last Name</label>
                          <div class="col-lg-10">
                            <input id="ulname" type="text" name="ulname" placeholder="Last Name" class="form-control" value="">
                          </div>
                        </div>
						<div class="form-group">
						...
						<div class="form-group">
                          ...
                          <div class="col-lg-10">
                            <input id="exp" type="number" max="60" min="0" step=".1"  name="exp" placeholder="Experience" class="form-control">
                          </div>
                        </div>
						<div class="form-group">
    ...
    <label for="{{$expertise['id']}}">{{$expertise['expertise_name']}}&nbsp;&nbsp;&nbsp;&nbsp;</label>
						...
						<div class="form-group">
                          <div class="col-lg-10">
						  	<input type="hidden" name="urole" value="lawyer">
                          </div>
                        </div>
						<div class="form-group">
