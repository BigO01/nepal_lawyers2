                      ...
                      <div class="col-sm-12">
                        <div class="featured-box featured-box-primary align-left mt-xlg">
                            <div class="box-content">
                               {!! Form::open(['route'=>'update_member', 'enctype'=>'multipart/form-data']) !!}
                                 ...
                                 <input type="hidden" name="register" value="{{ Auth::user()->role  }}" >
                                    <div class="section-holder"></div>
                                        <div class="section current center">
                                            <h2 class="heading-primary text-uppercase mb-md center">Edit your details</h2>
                                            <div class="row">
                                                <label>
                                                    <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-2 col-md-offset-5">
                                                        <div class="main-img-preview">
                                                            <input type="hidden" name="img" value="{{ Auth::user()->image_path }}" > {{-- URL::to('/public/images/dummy.png') --}}
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input class="form-control input-lg" type="text" name="first_name" placeholder="First Name" value="{{ Auth::user()->first_name }}">
                                                        <?php echo $errors->first('first_name', "<li style='color:red'>:message</li>") ?>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <input class="form-control input-lg" name="last_name" type="text" placeholder="Last Name" value="{{ Auth::user()->last_name }}">
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-4">
                                                        <input class="form-control input-lg" name="mobile" type="tel" pattern='[\+]\d{3}\d{1}\d{4}\d{3}' value="{{ Auth::user()->contact }}" placeholder="Mobile # +977 X XXXX XXX" required>
                                                        <?php echo $errors->first('mobile', "<li style='color:red'>:message</li>") ?>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <input class="form-control input-lg" name="homepn" type="tel" pattern='[\+]\d{3}\d{3}\d{4}\d{3}' value="{{ Auth::user()->office_contact }}" placeholder="Home Phone # +977 XXX XXXX XXX"> 
                                                        <?php echo $errors->first('homepn', "<li style='color:red'>:message</li>") ?>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <input class="form-control input-lg" name="officepn" type="tel" pattern='[\+]\d{3}\d{3}\d{4}\d{3}' value="{{ Auth::user()->home_contact }}" placeholder="Office Phone # +977 XXX XXXX XXX">
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-12"> 
                                                        <input class="form-control input-lg" name="address" value="{{ Auth::user()->address }}" type="text" placeholder="Address" data="required" />
                                        ...
                                        <div id="getRequestedData"></div>
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        <input class="next btn btn-lg btn-primary pull-right" type="submit" value="Update">
                                                    </div>
                                                </div>
                                            </div>           
                                        </div>
