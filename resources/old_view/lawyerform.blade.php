...
{{-- Main contant start --}}    
  ...
  <div class="container">
            ...
            <div class="sections">
                 {!! Form::open(['route'=>'lawyer', 'enctype'=>'multipart/form-data']) !!}
        		  ...
        		  <div class="form-group">
        			<div class="col-md-4 col-md-offset-4">
              	     ...
              	     <div class="row">
                        <div class="form-group">
                           <div class="col-md-12">
                               <input class="form-control input-lg" name="first_name" value="{{ $input['fname'] or old('first_name') }}" type="text" placeholder="Full Name *" data="required" /> 
                    ...
                    <div class="row">
                        <div class="form-group">
                           <div class="col-md-4">
                           	 ...
                           	 <input class="form-control input-lg"  name="mobile" value="{{ old('mobile') }}" type="tel" pattern='[\+]\d{11}' title="must be plus number with 11 digits"  placeholder="Mobile # +977 X XXXX XXX *" required data="required" />
                              <?php echo $errors->first('mobile', "<li style='color:red'>:message</li>") ?>
                           </div>
                           
                           	 <div class="col-md-4">
                            		<input class="form-control input-lg" name="homepn" type="tel" pattern='[\+]\d{13}' placeholder="Home Phone # +977 XXX XXXX XXX (Optional)"  /> 
                            	</div>
                            	<div class="col-md-4">
                            		<input class="form-control input-lg" name="officepn" type="tel" pattern='[\+]\d{13}' placeholder="Office Phone # +977 XXX XXXX XXX (Optional)"  /> 
                            	</div>
                         </div> 
                   </div> 
			...
			<div class="form-group">
                <div class="RegSpLeft" id="education">
                    <div class="col-md-8 mb-md">
                        <input class="form-control input-lg" name="education[]" type="text" placeholder="Education * (Click + to Add more than One)" data="required" />
                ...
                <div class="RegSpRight">
	             ...
	             <div class="row">
                      ...
                      <div class="row">
                           <div class="form-group">
                                 <div class="col-md-12"> 
                          		    <input id="datepicker" class="form-control input-lg" name="dob" value="{{ old('dob') }}" type="text"  placeholder="Date of Birth *"/>
                	     ...
                	     <div class="form-group">
                        	   <div class="col-md-12">
                           			<input class="form-control input-lg" name="website" value="{{ old('website') }}" type="text" placeholder="Website (Optional)"  	 /> 
					                   </div>
                            </div>
                        </div>
                  </div>
                        ...
                        <div class="section" section="Professional Information">
                        	...
                        	<div class="row">
								<div class="form-group">
                    <div class="col-md-12">                             
										<input class="form-control input-lg" name="license" type="text" value="{{ old('license') }}" placeholder="License #" data="required" />
                    <?php echo $errors->first('license', "<li style='color:red'>:message</li>") ?>
							...
							<div class="row">
								<div class="form-group">
                                    <div class="col-md-12">
		<input class="form-control input-lg" name="yoe" type="tel" placeholder="Year of Experience" value="{{ old('yoe') }}" pattern='\d{1,2}' data="required"/>
...
?>                                       
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-12">
                    <input class="form-control input-lg" name="areaOfPractice" value="{{ old('areaOfPractice') }}" type="text" placeholder="Area of Practice" data="required" />
...
?>                     
              ...
              <div class="form-group">                                  
								<input type="checkbox" name="language[]" value="English" id="English" />
									<div class="btn-group">
										<label for="English" class="btn btn-lg btn-default">
											<span class="[ glyphicon glyphicon-ok ]"></span>
											<span> </span>
										</label>
										<label for="English" class="btn btn-lg btn-primary">
											English
										</label>
									</div>
							</div>
						...
						<div class="col-xs-12 col-sm-6">
							<div class="form-group">
								<input type="checkbox" name="language[]" value="Nepali" id="Nepali"  />
									<div class="btn-group">
										<label for="Nepali" class="btn btn-lg btn-default">
											<span class="[ glyphicon glyphicon-ok ]"></span>
											<span> </span>
										</label>
										<label for="Nepali" class="btn btn-lg btn-primary">
											Nepali
										</label>
									</div>
							</div>
...
?>                        
						...
						<div class="row">
							<div class="form-group">
								<div class="col-md-6">
									<input class="form-control input-lg" name="firstfee" value="{{ old('firstfee') }}" type="number" placeholder="First Time (Rs)" data="required" />
                  <?php echo $errors->first('firstfee', "<li style='color:red'>:message</li>") ?>
								</div>
								<div class="col-md-6">
									<input class="form-control input-lg" name="hourfee" value="{{ old('hourfee') }}" type="number" placeholder="Hourly Rate (Rs)" data="required" />
